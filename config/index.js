...
config.globals = {
  ...
  '__DOPS_SERVER_HOST__': JSON.stringify(argv.dops_server_host || process.env.API_SERVER),
  '__IFRAME_URL__': JSON.stringify(argv.iframe_url || process.env.IFRAME_URL),
  '__ELASTIC_SERVER_HOST__': JSON.stringify(argv.dops_search_engine || 'dops-search-engine.auto.dops.open.global'),
}
