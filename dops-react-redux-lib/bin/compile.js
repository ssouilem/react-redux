...
compiler.run((err, stats) => {
  ...
  fs.copySync(paths.sharedBase('src/static'), paths.rootBase('dist'))
  if (fs.existsSync(paths.codeBase('src/static'))) {
    fs.copySync(paths.codeBase('src/static'), paths.rootBase('dist'))
  }
  ...
  fs.writeFileSync(targetcfManifestFile, cfManifestNewContent)
})
